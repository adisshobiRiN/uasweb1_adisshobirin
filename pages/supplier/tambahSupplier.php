                            ...
                            <div class="card">
                                ...
                                <form role="form" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="post_supplier"
                                            value="Tambah">
...
<?php
if (isset($_POST['post_supplier'])) {
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $noTelp = $_POST['no_telp'];

    $postData = mysqli_query($connect, "INSERT INTO supplier (nama, alamat, no_telp) VALUES ('$nama', '$alamat', '$noTelp')");
