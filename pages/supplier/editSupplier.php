...
$idDetail = $_GET['id'];
$getData = mysqli_query($connect, "SELECT * FROM supplier WHERE id='$idDetail'");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama" required
                                                placeholder="Nama" value="<?php echo $detailData['nama'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea name="alamat" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat" required><?php echo $detailData['alamat'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>No Telp</label>
                                            <input type="text" class="form-control" name="no_telp" required
                                                placeholder="No Telp" value="<?php echo $detailData['no_telp'] ?>">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="update_supplier"
                                            value="Ubah">
...
if (isset($_POST['update_supplier'])) {
    ...
    $updateData = mysqli_query($connect, "UPDATE supplier SET nama='$nama', alamat='$alamat', no_telp='$noTelp' WHERE id='$idDetail'");
