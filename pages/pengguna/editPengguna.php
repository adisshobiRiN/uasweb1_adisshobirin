...
$idDetail = $_GET['id'];
$getData = mysqli_query($connect, "SELECT * FROM pengguna WHERE id='$idDetail'");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_lengkap" required
                                                placeholder="Nama Lengkap" value="<?php echo $detailData['nama_lengkap'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Username</label>
                                            <input type="text" class="form-control" name="username" required
                                                placeholder="Username" value="<?php echo $detailData['username'] ?>">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="update_pengguna"
                                            value="Ubah">
...
if (isset($_POST['update_pengguna'])) {
    ...
    $postData = mysqli_query($connect, "UPDATE pengguna SET nama_lengkap='$namaLengkap', username='$username' WHERE id='$idDetail'");
