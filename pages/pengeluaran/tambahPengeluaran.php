                            ...
                            <div class="card">
                                ...
                                <form role="form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="kebutuhan" id="" cols="30" rows="5" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="stok_pengeluaran"
                                                        required placeholder="Stok Keluar">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="post_pengeluaran"
                                            value="Tambah">
...
<?php
if (isset($_POST['post_pengeluaran'])) {
    $stok = $_POST['id_stok'];
    $tglPengeluaran = $_POST['tgl_pengeluaran'];
    $kebutuhan = $_POST['kebutuhan'];
    $stokKeluar = $_POST['stok_pengeluaran'];

    $postData = mysqli_query($connect, "INSERT INTO pengeluaran (id_stok, tgl_pengeluaran, kebutuhan, stok_pengeluaran) VALUES ('$stok', '$tglPengeluaran', '$kebutuhan', '$stokKeluar')");
