                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="my-3 w-100 d-flex justify-content-end">
                                        <a href="tambahPengeluaran.php" class="btn btn-primary">Tambah</a>
                                    </div>
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $sql = mysqli_query($connect, "SELECT p.id, s.nama_stok, p.tgl_pengeluaran, p.kebutuhan, p.stok_pengeluaran FROM `pengeluaran` p INNER JOIN stok s ON p.id_stok = s.id");
                                            while ($data = mysqli_fetch_assoc($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $data['tgl_pengeluaran'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $data['kebutuhan'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $data['stok_pengeluaran'] ?>
                                                    </td>
                                                    <td>
                                                        <a href="editPengeluaran.php?id=<?php echo $data['id'] ?>"
                                                            class="btn btn-info">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <a href="hapusPengeluaran.php?id=<?php echo $data['id'] ?>"
