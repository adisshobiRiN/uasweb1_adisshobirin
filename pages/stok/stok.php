                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="my-3 w-100 d-flex justify-content-end">
                                        <a href="tambahStok.php" class="btn btn-primary">Tambah</a>
                                    </div>
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $sql = mysqli_query($connect, "SELECT * FROM stok");
                                            while ($data = mysqli_fetch_assoc($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editStok.php?id=<?php echo $data['id'] ?>"
                                                            class="btn btn-info">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <a href="hapusStok.php?id=<?php echo $data['id'] ?>"
