                            ...
                            <div class="card">
                                ...
                                <form role="form" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="post_stok" value="Tambah">
...
if (isset($_POST['post_stok'])) {
    ...
    $postData = mysqli_query($connect, "INSERT INTO stok (nama_stok, merk, jenis, lokasi, stok) VALUES ('$namaStok', '$merk', '$jenis', '$lokasi', '$stok')");
