                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="my-3 w-100 d-flex justify-content-end">
                                        <a href="tambahPemasukan.php" class="btn btn-primary">Tambah</a>
                                    </div>
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $sql = mysqli_query($connect, "SELECT p.id, s.nama_stok, p.tgl_pemasukan, sp.nama, p.stok_pemasukan FROM `pemasukan` p INNER JOIN stok s ON p.id_stok = s.id INNER JOIN supplier sp ON p.id_supplier = sp.id");
                                            while ($data = mysqli_fetch_assoc($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $data['nama_stok'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $data['tgl_pemasukan'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $data['nama'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $data['stok_pemasukan'] ?>
                                                    </td>
                                                    <td>
                                                        <a href="editPemasukan.php?id=<?php echo $data['id'] ?>"
                                                            class="btn btn-info">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <a href="hapusPemasukan.php?id=<?php echo $data['id'] ?>"
