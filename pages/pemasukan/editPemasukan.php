...
$idDetail = $_GET['id'];
$getData = mysqli_query($connect, "SELECT * FROM pemasukan WHERE id='$idDetail'");
        ...
        <aside class="main-sidebar elevation-4" style="background-color: #003467;">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="pemasukan.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Pemasukan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                ...
                                <form role="form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="tgl_pemasukan"
                                                        ...
                                                        value="<?php echo $detailData['tgl_pemasukan'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_supplier" class="form-control" required>
                                                        ...
                                                        while ($dataSupplier = mysqli_fetch_assoc($supplier)) {
                                                            if ($dataSupplier['id'] == $detailData['id_supplier']) {
                                                                $selected = 'selected';
                                                            } else {
                                                                $selected = '';
                                                            }
                                                            $option = '<option value="' . $dataSupplier['id'] . '"' . $selected . '>' . $dataSupplier['nama'] . '</option>';
                                                            echo $option;
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="stok_pemasukan"
                                                        required placeholder="Stok Masuk"
                                                        value="<?php echo $detailData['stok_pemasukan'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="update_pemasukan"
                                            value="Ubah">
                                        <a href="pemasukan.php" class="btn btn-danger">Batal</a>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
...
<?php
if (isset($_POST['update_pemasukan'])) {
    $stok = $_POST['id_stok'];
    $tglPemasukan = $_POST['tgl_pemasukan'];
    $supplier = $_POST['id_supplier'];
    $stokMasuk = $_POST['stok_pemasukan'];

    $updateData = mysqli_query($connect, "UPDATE pemasukan SET id_stok='$stok', tgl_pemasukan='$tglPemasukan', id_supplier='$supplier', stok_pemasukan='$stokMasuk' WHERE id='$idDetail'");
