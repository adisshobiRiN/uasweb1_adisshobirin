                            ...
                            <div class="card">
                                ...
                                <form role="form" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_stok" class="form-control" required>
                                                        ...
                                                        while ($dataStok = mysqli_fetch_assoc($stok)) {
                                                            ?>
                                                            <option value="<?php echo $dataStok['id'] ?>"><?php echo $dataStok['nama_stok'] ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_supplier" class="form-control" required>
                                                        ...
                                                        while ($dataSupplier = mysqli_fetch_assoc($supplier)) {
                                                            ?>
                                                            <option value="<?php echo $dataSupplier['id'] ?>"><?php echo $dataSupplier['nama'] ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="post_pemasukan"
                                            value="Tambah">
...
<?php
if (isset($_POST['post_pemasukan'])) {
    $stok = $_POST['id_stok'];
    $tglPemasukan = $_POST['tgl_pemasukan'];
    $supplier = $_POST['id_supplier'];
    $stokMasuk = $_POST['stok_pemasukan'];

    $postData = mysqli_query($connect, "INSERT INTO pemasukan (id_stok, tgl_pemasukan, id_supplier, stok_pemasukan) VALUES ('$stok', '$tglPemasukan', '$supplier', '$stokMasuk')");
